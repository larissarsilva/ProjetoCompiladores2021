...
class Main {
  ...
  //Imprime uma string formatada no dest
  static void printf(String fmt, Object ...args) {
	  //substitui todos os argumentos do tipo Token pelo seu texto
  ...
  public static void main(String args[]) throws Exception {
     //Ler de uma String 
     CharStream src = CharStreams.fromFileName("teste.Compilador"); // Leitura do arquivo
     ...
     CompiladorParser.GroupContext ctx = parser.group();
